...
var sumardos = function sumardos(a, b) {
  return a + b;
};

console.log(sumardos(10, 90));

var aplicarOperacion = function aplicarOperacion(operacion) {
  return operacion;
};

console.log(aplicarOperacion(sumardos(100, 200)));

var aplicarOperacion2 = function aplicarOperacion2(operacion1, operacion2) {
